...
module ogpf
    ...
    type, public :: gpf
        ...
        ! animation
        real  :: pause_seconds = 0.0  ! keep plot on screen for this value in seconds
    ...
    contains
        ...
        procedure, pass, public :: scatter3d  => scatter
...
! ------------------------------------------------------------------------    
    subroutine scatter(this, x, y, z, lspec, palette)
    ...
    subroutine sub_animation_start(this, pause_seconds)
        ...
        if (present(pause_seconds)) then
            ...
            this%pause_seconds = 2.0  ! delay in second
        end if
